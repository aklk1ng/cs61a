...
class BankAccount:
    ...
    def deposit(self, amount):
        ...
        self.track(before, self.balance)
        return self.balance
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            self.track(self.balance, self.balance)
    ...
    def track(self, before, after):
        """Keeps track of each transaction made on the account, even if the
